...
- [Управленческая записка](docs/management-note.docx) — 12 разделов, закрывают
  П1–П9; все числа сверены с `results/`. Разделы записки опираются на материалы
  ниже.
- [Реестр источников записки](docs/sources.md) — 16 позиций с DOI и способом
  проверки; PDF статей в репозиторий не входят.
