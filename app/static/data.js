...
export function renderData(ctx) {
  ...
  }).join('')}</table><div class="note">${esc(ds.source === 'организаторы' ? 'Исходные файлы организаторов из cases/case02. Расчёт идёт по ним.' : `Загруженный набор, активирован ${ds.activated_at || ''}. Папка: ${ds.root}`)}</div>`
